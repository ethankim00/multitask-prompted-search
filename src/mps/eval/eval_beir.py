...
class EvaluationArguments:
    ...
    data_dir: str = "./data"
    split: str = field(
        default="test", metadata={"help": "Dataset Split to evaluate on"}
    )
...
def evaluate(eval_args: EvaluationArguments):
    ...
    dataset_args = BeirDatasetArguments(
        dataset=eval_args.dataset, data_dir=eval_args.data_dir
    )
    ...
    evaluator = load_ir_evaluator(
        corpus, queries, qrels, name=eval_args.split, max_corpus_size=max_corpus_size
    )
